...
import { Book } from '../common/api/book/Book';
...
export class BookService {
  ...
  getAllPageable(page: any): Observable<ApiResponse<Book>> {
  return this.apiService.getAllPageable<ApiResponse<Book>>(this.BOOK_PATH + this.BOOK_PATH_PAGE, page);
}
